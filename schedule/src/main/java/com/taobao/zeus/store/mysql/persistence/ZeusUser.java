...
public class ZeusUser{
	...
	public static final ZeusUser ADMIN=new ZeusUser(){
		public String getEmail() {return "qiujw@ucweb.com";};
		public String getName() {return "仇家伟";};
		public String getPhone() {return "13632215891";};
		public String getUid() {return "qiujw";};
	};
	@Id
	@GeneratedValue
	private Long id;
