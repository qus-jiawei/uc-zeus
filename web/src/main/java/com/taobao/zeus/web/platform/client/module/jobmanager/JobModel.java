...
public class JobModel implements Serializable{
	...
	public JobModel copy(){
		...
		model.setAllResources(new ArrayList<Map<String,String>>(getAllResources()));
		...
		model.setLocalProperties(new HashMap<String, String>(getLocalProperties()));
		model.setLocalResources(new ArrayList<Map<String,String>>(getLocalResources()));
